...
=end
  ...
  # Syntax: N/A
  #
  # Usage Examples:  if(browser.is_firefox_installed?(40))
  #                      # Execute Firefox 7.x specific code
  #                  end
  #
  #=============================================================================#
  def is_firefox_installed?(iVersion = 40)
  ...
  #
  #=============================================================================#
  def is_ie_installed?(iVersion = 11)
  ...
  # Syntax: N/A
  #
  # Usage Examples:  if(browser.is_safari_installed?(6))
  #                      # Execute Safari 6.x specific code
  #                  end
  #
  #=============================================================================#
  def is_safari_installed?(iVersion = 6)
