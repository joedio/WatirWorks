#--
#=============================================================================#
# File: watirworks_valid_unittest.rb
#
...
#=============================================================================#
class UnitTest_Valid < Test::Unit::TestCase
  ...
  #===========================================================================#
  # Testcase method: test_Valid_001_Password
  #--
  #
  # Description: Test the methods:
  #                       isValid_Password(...)
  #===========================================================================#
  def test_Valid_001_Password

    puts2("")
    puts2("#######################")
    puts2("Testcase: test_Valid_001_Password")
    puts2("#######################")
    ...
    aPasswords.each do | sPassword |
      ...
      if(sPassword.valid_password?) # Check validity
        puts2("Valid")
      else
        puts2("Invalid")
      end # Check validity
  ...
  end # End of test method - test_Valid_001_Password


  #===========================================================================#
  # Testcase method: test_Valid_002_ZipCode
  #--
  #
  # Description: Test the methods:
  #                       valid_zip_code?(...)
  #===========================================================================#
  def test_Valid_002_ZipCode

    puts2("")
    puts2("#######################")
    puts2("Testcase: test_Valid_002_ZipCode")
    puts2("#######################")
    ...
    aZipCodes.each do | sZipCode |
      ...
      if(sZipCode.valid_zip_code?) # Check validity
        puts2("Valid")
      else
        puts2("Invalid")
      end # Check validity
  ...
  end # End of test method - test_Valid_002_ZipCode

  #===========================================================================#
  # Testcase method: test_Valid_003_TopLevelDomain
  #--
  #
  # Description: Test the methods:
  #                       isValid_TopLevelDomain(...)
  #===========================================================================#
  def test_Valid_003_TopLevelDomain

    puts2("")
    puts2("#######################")
    puts2("Testcase: test_Valid_003_TopLevelDomain")
    puts2("#######################")
    ...
    sTopLevelDomains.each do | sTLD |
      ...
      if(sTLD.valid_top_level_domain?) # Check validity
        puts2("Valid")
      else
        puts2("Invalid")
      end # Check validity
  ...
  end # End of test method - test_Valid_003_TopLevelDomain

  #===========================================================================#
  # Testcase method: test_Valid_004_EmailAddress
  #--
  #
  # Description: Test the methods:
  #                       valid_email_address?(...)
  #===========================================================================#
  def test_Valid_004_EmailAddress

    puts2("")
    puts2("#######################")
    puts2("Testcase: test_Valid_004_EmailAddress")
    puts2("#######################")
    ...
    sEmailAddresses.each do | sAddress |
      ...
      if(sAddress.valid_email_address?) # Check validity
        puts2("Valid")
      else
        puts2("Invalid")
      end # Check validity
  ...
  end # End of test method - test_Valid_004_EmailAddress


end # end of Class - UnitTest_Valid
